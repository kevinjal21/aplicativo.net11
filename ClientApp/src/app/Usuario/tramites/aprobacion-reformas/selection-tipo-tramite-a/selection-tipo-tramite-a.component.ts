...
@Component({
  selector: 'app-selection-tipo-tramite-a',
  templateUrl: './selection-tipo-tramite-a.component.html',
  styleUrls: ['./selection-tipo-tramite-a.component.css']
})
export class SelectionTipoTramiteAComponent implements OnInit {
  ...
  onSubmit(form: NgForm) {
    ...
    if (this.registerForm.invalid) {
      ...
      if (this.tipoTramite == "CLUB") {
        this.router.navigate(['AprobacionGestion/' + this.codicgoTram]);
