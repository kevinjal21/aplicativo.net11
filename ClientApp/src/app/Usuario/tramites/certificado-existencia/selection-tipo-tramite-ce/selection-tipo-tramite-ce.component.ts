...
@Component({
  selector: 'app-selection-tipo-tramite-ce',
  templateUrl: './selection-tipo-tramite-ce.component.html',
  styleUrls: ['./selection-tipo-tramite-ce.component.css']
})
export class SelectionTipoTramiteCeComponent implements OnInit {
