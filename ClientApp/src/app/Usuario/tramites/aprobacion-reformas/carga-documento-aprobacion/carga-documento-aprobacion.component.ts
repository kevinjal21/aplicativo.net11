...
@Component({
  selector: 'app-carga-documento-aprobacion',
  templateUrl: './carga-documento-aprobacion.component.html',
  styleUrls: ['./carga-documento-aprobacion.component.css']
})
export class CargaDocumentoAprobacionComponent implements OnInit {
