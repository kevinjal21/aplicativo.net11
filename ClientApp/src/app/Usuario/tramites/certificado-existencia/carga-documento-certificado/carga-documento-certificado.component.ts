...
@Component({
  selector: 'app-carga-documento-certificado',
  templateUrl: './carga-documento-certificado.component.html',
  styleUrls: ['./carga-documento-certificado.component.css']
})
export class CargaDocumentoCertificadoComponent implements OnInit {
  ...
  regresar()
  {
    this.router.navigate(['CertificadoGestion/'+this.route.snapshot.paramMap.get('codt')]).then(
      () =>
      {
