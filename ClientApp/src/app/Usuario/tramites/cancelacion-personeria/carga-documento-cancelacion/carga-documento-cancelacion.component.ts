...
@Component({
  selector: 'app-carga-documento-cancelacion',
  templateUrl: './carga-documento-cancelacion.component.html',
  styleUrls: ['./carga-documento-cancelacion.component.css']
})
export class CargaDocumentoCancelacionComponent implements OnInit {
  ...
  regresar()
  {
    this.router.navigate(['CancelacionGestion/'+this.route.snapshot.paramMap.get('codt')]).then(
      () =>
      {
