...
@Component({
  selector: 'app-edit-elim-usuario',
  templateUrl: './edit-elim-usuario.component.html',
  styleUrls: ['./edit-elim-usuario.component.css']
})
export class EditElimUsuarioComponent implements OnInit {
