...
@Component({
  selector: 'app-add-funcionario-deporte',
  templateUrl: './add-funcionario-deporte.component.html',
  styleUrls: ['./add-funcionario-deporte.component.css']
})
export class AddFuncionarioDeporteComponent implements OnInit {
  ...
  getAllUsuarios() {
    this.servicioUsuario.getUsuario().subscribe(useri => {
      ...
      for (let index = 0; index < this.usuarios.length; index++) {
        ...
        if (element.rol == "FuncionarioDeporte") {
